...
public class AccountModel implements Account {
    ...
    public AccountModel(String firstName, String lastName, String cardDetails, String userId) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.cardDetails = cardDetails;
        this.userId = userId;
    ...
    public AccountModel(String firstName, String lastName, String cardDetails) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.cardDetails = cardDetails;
    }
